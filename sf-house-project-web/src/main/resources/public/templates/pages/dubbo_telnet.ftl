<html>
<head>
    <title> Dubbo Telnet 直连</title>
</head>
<body>

<form id="dubbo" action="/dubbo/telnet/gen" method="POST">
    <br>服务类信息:<br>
    类名：<input type="text" name="className" value="${(param.className)!'com.goods.GoodsReadApiFacade'}" size="100"><br>
    方法名：<input type="text" name="methodName" value="${(param.methodName)!'queryGoodsDesc'}" size="100"><br>
    入参：<input type="text" name="methodParam" value="${(param.methodParam)!'[59149962]'}" size="100"><br>
    <br>环境参数:<br>
